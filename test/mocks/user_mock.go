...
//
//	mockgen -source=internal/domain/user.go -destination=test/mocks/user_mock.go -package=mocks
//
...
func (m *MockUserRepository) FindAll(ctx context.Context, params domain.FindAllParams) (*domain.Paginated[*domain.User], error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FindAll", ctx, params)
	ret0, _ := ret[0].(*domain.Paginated[*domain.User])
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// FindAll indicates an expected call of FindAll.
func (mr *MockUserRepositoryMockRecorder) FindAll(ctx, params any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FindAll", reflect.TypeOf((*MockUserRepository)(nil).FindAll), ctx, params)
}
...
// FindAll mocks base method.
func (m *MockUserService) FindAll(ctx context.Context, params domain.FindAllParams) (*domain.Paginated[*domain.User], error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FindAll", ctx, params)
	ret0, _ := ret[0].(*domain.Paginated[*domain.User])
	ret1, _ := ret[1].(error)
...
// FindAll indicates an expected call of FindAll.
func (mr *MockUserServiceMockRecorder) FindAll(ctx, params any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FindAll", reflect.TypeOf((*MockUserService)(nil).FindAll), ctx, params)
}
